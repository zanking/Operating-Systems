...
echo using SCHED_FIFO with 10 simultaneous process PRIORITY 1
...
echo using SCHED_RR with 10 simultaneous process PRIORITY 0
...
echo using SCHED_RR with 10 simultaneous process PRIORITY 1
